...
public class BasketTest {
    ...
    void consolidateBasketTest() {
        ...
        basket.add("productCode5", "myProduct5", 10);
        ...
        assertEquals(basketSize.get(4).getProductCode(), "productCode5");
        assertEquals(basketSize.get(4).getProductName(), "myProduct5");
        assertEquals(basketSize.get(4).getQuantity(), 10);
    }
}
